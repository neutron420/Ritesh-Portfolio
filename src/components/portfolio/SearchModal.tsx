...
const SearchModal = ({ isOpen, onClose }: SearchModalProps) => {
  ...
  return (
    ...
    >
      <div
        className="w-full max-w-2xl bg-[#0a0a0a] border border-zinc-800/50 rounded-2xl shadow-[0_0_50px_-12px_rgba(0,0,0,0.5)] overflow-hidden animate-fade-up pointer-events-auto"
      ...
      >
            ...
            <div className="p-2">
              {filteredResults.map((result, index) => (
                ...
                >
                  ...
                  <ArrowRight className={`w-4 h-4 transition-transform duration-200 ${index === selectedIndex ? "translate-x-1 text-white" : "text-zinc-600"}`} />
                </a>
              ))}
            </div>
          ) : (
        ...
        {/* Footer */}
        <div className="px-4 py-3 border-t border-zinc-800/50 bg-[#0a0a0a] flex items-center justify-between text-[10px] text-zinc-600 uppercase tracking-widest font-bold">
